...
- **`market_brief.py` (ที่ workflow ใช้)** — สร้างภาพ **"MARKET BRIEF"** หน้าเดียวธีมมืด:
  ดึงดัชนีทุกตลาด + ค่าเงิน/ทองคำ/น้ำมัน/Bitcoin (Yahoo Finance) → ให้ **Claude เขียนบทวิเคราะห์**
  (เซกเตอร์จับตา, ปฏิทินข่าว, โฟกัสหุ้นไทย) → เรนเดอร์เป็น PNG → **แนบส่งอีเมล** ทุกเช้า
  **07:30 น. (เวลาไทย)** จันทร์–ศุกร์ (เปิดอีเมลแล้วส่งรูปต่อเข้ากลุ่ม LINE ทีมได้เลย)
