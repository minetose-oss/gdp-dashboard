...
- **`market_brief.py` (ที่ workflow ใช้)** — สร้าง **"MARKET BRIEF"** หน้าเดียวธีมมืด:
  ดึงดัชนีทุกตลาด + หุ้นเด่น + ค่าเงิน/ทองคำ/น้ำมัน/Bitcoin (Yahoo Finance, ข้อมูลจริง) →
  ให้ **Claude ค้นข่าวจริงด้วย web search** แล้วเขียนพาดหัว + บทวิเคราะห์ (สาเหตุที่ดัชนีขึ้น/ลง,
  เซกเตอร์, ปฏิทินข่าว) จากข่าวจริงนั้น → เรนเดอร์เป็น **PDF + PNG** → **แนบส่งอีเมล**
  ทุกเช้าจันทร์–ศุกร์

  แนบ 2 ไฟล์เพราะใช้คนละงาน:
  - **PDF** — ตัวอักษรเป็นเวกเตอร์ ซูมบนมือถือ/iPad ได้คมทุกระดับ (ไฟล์เล็กกว่าด้วย)
  - **PNG** — รูปภาพ สำหรับส่งต่อเข้ากลุ่ม LINE

  **สี**: เขียว `#14b8a6` / แดง `#f6465d` เลือกให้ผ่านเกณฑ์การมองเห็นของคนตาบอดสีเขียว-แดง
  (CVD ΔE 10.2) และมีลูกศร ▲▼ กับเครื่องหมาย +/- กำกับเสมอ ไม่ใช้สีสื่อความหมายเพียงอย่างเดียว
